...
# khulnasoft/meshplay-operator-bundle:$VERSION and khulnasoft/meshplay-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= khulnasoft/meshplay-operator
...
IMG ?= khulnasoft/meshplay-operator:stable-latest
